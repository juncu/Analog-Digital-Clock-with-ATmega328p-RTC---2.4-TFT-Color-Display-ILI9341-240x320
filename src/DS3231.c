...
bool getTime(unsigned char *p3, unsigned char *p2, unsigned char *p1, unsigned char *p0, unsigned char hour_format)
{                        
		 unsigned char tmp = 0;    
...
bool getDate(unsigned char *p4, unsigned char *p3, unsigned char *p2, unsigned char *p0, unsigned char *p1)
{
         unsigned char tmp = 0;
         
         tmp = DS3231_Read(ageoffsetREG);
         *p0 = bcd_to_decimal(tmp);
...
*/                       
/*
void showDayEN(unsigned char day_val)
{
     switch(day_val)
     {
          case 1:
...
*/
/*
void showDayDE(unsigned char day_val)
{
     switch(day_val)
     {
          case 1:
